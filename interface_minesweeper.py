...
def startup():
    ...
    Button(root, text='Easy', font= ('Helvetica 20'), width=8, height=1,
           command=lambda n=10: create_grid(n)).grid(row=4,column=0)
...
def create_grid(n): #will receive number of bombs as well ?
                    #will receive the grid generated by the game code ?
